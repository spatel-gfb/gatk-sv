...
workflow GenotypeComplexVariants {
    input {
        ...
        RuntimeAttr? runtime_attr_gnomad_rerun_subset
    }
    ...
    scatter ( i in range(length(contigs)) ) {
        ...
        call GnomadRerunSubset {
            input:
                vcf = complex_resolve_vcfs[i],
                prefix = "~{cohort_name}.~{contig}.ins_unk_subset",
                sv_base_mini_docker = sv_base_mini_docker,
                runtime_attr_override = runtime_attr_gnomad_rerun_subset
        }
